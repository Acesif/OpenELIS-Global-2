...
const BarcodeVisualFeedback = ({ state = 'ready', errorMessage = '' }) => {
  ...
  const renderReadyState = () => {
    return (
      <div
        ...
        title={intl.formatMessage({ id: 'barcode.ready', defaultMessage: 'Ready to scan' })}
      >
        <Renew
          size={24}
          style={{
  ...
  const renderSuccessState = () => {
    return (
      <div
        ...
        title={intl.formatMessage({ id: 'barcode.success', defaultMessage: 'Location found' })}
      >
        <Checkmark
          size={20}
          style={{
  ...
  const renderErrorState = () => {
    const displayMessage = errorMessage || intl.formatMessage({ id: 'barcode.invalidFormat', defaultMessage: 'Invalid barcode format' });
