...
/**
 * Service for generating barcode labels for storage locations
 * Handles label generation, print history tracking
 */
public interface LabelManagementService {
    ...
    /**
     * Track print history for a location
     * Records audit trail of label printing
     * 
