...
/**
 * Service for validating short codes for storage locations
 * Validates format, uniqueness, and generates change warnings
 */
public interface ShortCodeValidationService {
    ...
    /**
     * Validate short code uniqueness within context
     * Checks if short code already exists for a different location of the same type
     * 
     * @param shortCode The short code to validate
     * @param context The context type: "device", "shelf", or "rack"
     * @param locationId The ID of the location being validated (for updates, allows same location)
     * @return Validation result
     */
    ShortCodeValidationResult validateUniqueness(String shortCode, String context, String locationId);

    /**
     * Check if short code change requires a warning
     * Returns warning message if old and new codes are different, null otherwise
     * 
