...
public class StatusOfSampleServiceTest extends BaseWebContextSensitiveTest {
    ...
    public void getAllStatusOfSamples() {
        ...
        StatusOfSample status1 = statusOfSamples.stream()
            .filter(s -> "Status 1".equals(s.getStatusOfSampleName()))
            .findFirst()
            .orElse(null);
        StatusOfSample status2 = statusOfSamples.stream()
            .filter(s -> "Status 2".equals(s.getStatusOfSampleName()))
            .findFirst()
            .orElse(null);
